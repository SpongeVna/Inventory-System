...
<div class="container mt-4">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h3 class="mb-0">Scan Barang Masuk</h3>
    <div>
  ...
  <div class="card shadow-sm">
    <div class="card-body">
      ...
      <p class="text-muted">Arahkan kamera ke barcode barang untuk menambah stok otomatis.</p>
      ...
      <form id="scanForm" method="POST" action="scan_in_action.php" class="d-none">
        <div class="mb-3">
...
<script src="/inventory-system/assets/js/scan_in.js"></script>
